...
# Upgrade system-level packages to resolve vulnerabilities in /usr/local/
...
# Install the wheel package locally along with explicit security constraints in a single resolution pass
