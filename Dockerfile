...
# Upgrade system-wide site-packages as root to resolve vulnerabilities in /usr/local/
...
RUN pip install --user --no-cache-dir --upgrade "setuptools>=78.1.1" "wheel>=0.46.2" "jaraco.context>=6.1.0" "msgpack>=1.2.1" \
