...
def main():
    ...
    res_api = client.post(
        "/api/twin/validate",
        json={
            "change": json.loads(change_warn.read_text()),
            "policy": json.loads(policy_warn.read_text()),
        },
        headers=headers,
    )
