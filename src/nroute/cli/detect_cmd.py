...
def _load_traffic_data(traffic_path: str, is_json: bool) -> Any:
    """Load and return traffic features CSV as a pandas DataFrame."""
    import pandas as pd
...
def _init_detector(model_path: str, allow_unsafe: bool, is_json: bool) -> Any:
    """Initialize and load the AnomalyDetector."""
...
def _run_detection(detector: Any, features: Any, is_json: bool) -> Any:
    """Perform anomaly detection using the detector and features."""
    try:
...
def _output_json_results(results: Any) -> None:
    """Output anomaly detection results in JSON format."""
    import json
...
def _output_console_results(results: Any) -> None:
    """Output anomaly detection results in text/console format."""
    console.print()
