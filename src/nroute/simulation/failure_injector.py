...
class FailureInjector:
    ...
    def apply(self, topology: Topology, current_tick: int) -> None:
        ...
        """
        if current_tick not in self.events:
            return

        handlers = {
            "link_failure": self._handle_link_failure,
            "node_failure": self._handle_node_failure,
            "link_recovery": self._handle_link_recovery,
            "node_recovery": self._handle_node_recovery,
            "latency_spike": self._handle_latency_spike,
            "restore_latency": self._handle_restore_latency,
        }
