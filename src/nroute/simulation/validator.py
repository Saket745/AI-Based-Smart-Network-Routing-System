...
class PreFlightValidator:
    ...
    def _parse_change_input(
        ...
        """Parse change input and compute its sha256 hash and ID."""
    ...
    def _parse_policy_input(
        ...
        """Parse policy configuration and compute its sha256 hash."""
        if policy is None:
    ...
    def _evaluate_policy_rules(
        ...
        """Evaluate blocking and warning conditions based on blast radius."""
    ...
    def _determine_verdict(
        ...
        """Determine validation verdict, gate pass flag, and summary message."""
    ...
    def _build_blast_summary_and_critical_deltas(
        ...
        """Construct machine-readable blast radius summary and critical path deltas."""
        blast_summary = {
    ...
    def validate(
        ...
        # 1. Parse change and policy inputs
        ...
        # 4. Evaluate policy rules and determine verdict
        ...
        # 5. Construct blast summary and critical path deltas
