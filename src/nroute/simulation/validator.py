...
class PreFlightValidator:
    ...
    def _parse_change_input(
        ...
        """Parse and validate change patch input into ConfigChange object, change_id, and hash."""
    ...
    def _parse_policy_input(
        ...
        """Parse and validate policy input into PolicyGateConfig object and hash."""
        if policy is None:
    ...
    def _evaluate_policy_rules(
        ...
        """Evaluate blocking and warning policy rules against blast radius metrics."""
    ...
    def _determine_verdict(
        ...
        """Assign ValidationVerdict based on strict precedence: BLOCK > WARN > PASS."""
    ...
    def _build_blast_summary_and_critical_deltas(
        ...
        """Construct blast radius summary dict and critical path deltas list."""
        blast_summary = {
