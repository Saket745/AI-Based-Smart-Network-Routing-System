...
def validate_file_path(
    ...
    Args:
        path: The file path to validate (str or Path).
        must_exist: Whether the path must exist on the filesystem.
        allowed_roots: Optional list of directory roots that the path must reside under.

    Returns:
        The validated, resolved Path object.

    Raises:
        ValidationError: If the path is empty, invalid format, does not exist, or violates allowed roots.
    """
