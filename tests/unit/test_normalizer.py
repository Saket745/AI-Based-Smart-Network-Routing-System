...
def test_normalize_topology_missing_node_id() -> None:
    ...
    raw_nodes: list[dict[str, Any]] = [{"capacity": 1000.0}]
    raw_edges: list[dict[str, Any]] = []
...
def test_normalize_topology_invalid_node_attrs() -> None:
    ...
    raw_nodes: list[dict[str, Any]] = [{"id": "A", "type": "invalid_type"}]
    raw_edges: list[dict[str, Any]] = []
...
def test_normalize_topology_missing_edge_endpoints() -> None:
    ...
    raw_nodes: list[dict[str, Any]] = [{"id": "A"}, {"id": "B"}]

    # Missing destination
    raw_edges: list[dict[str, Any]] = [{"source": "A"}]
...
def test_normalize_topology_invalid_edge_attrs() -> None:
    ...
    raw_nodes: list[dict[str, Any]] = [{"id": "A"}, {"id": "B"}]
    raw_edges: list[dict[str, Any]] = [{"src": "A", "dst": "B", "bandwidth": -100.0}]
