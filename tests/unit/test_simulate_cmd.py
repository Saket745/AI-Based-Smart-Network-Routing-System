...
class TestSimulateCLI:
    ...
    def test_run_sim_missing_topology_prints_ux_tip(
        ...
        """Test that missing topology file prints the helpful UX tip suggestion."""
        result = runner.invoke(
            simulate_cmd,
        ...
        assert "UX Tip" in result.output
    ...
    def test_run_sim_missing_topology_json_output_includes_suggestion(
        ...
        """Test that missing topology file in JSON mode contains the suggestion key."""
        result = runner.invoke(
            simulate_cmd,
            ["run", "--topology", topo_file],
        ...
        assert "nroute topology generate" in data["suggestion"]
